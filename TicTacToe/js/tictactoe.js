let activePlayer = 'X';
//This variable above keep track of who's turn it is.
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/smile1.jpeg")';
            //Active player may only be "X" or "O" so, if not "X" it must be "O".
        } else {
            //If activePlayer is equal to "O", then o.png is placed in html.
            select.style.backgroundImage = 'url("images/grim.jpeg")';
        }
  ...
  function checkWinConditions() {
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        function animateLineDrawing() {
            ...
            c.lineWidth = 10;
            //This method sets the color of or line.
